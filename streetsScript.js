...
function startHunter(){
    outOfBattle()
    if (hero.hp <=0){
        startEvent("images/forest/forestBg.jpg", "", 'Сил сражаться больше нет. Вы чувствуете, как зубы впиваются в вашу плоть. В глазах закрываются, вы проваливаетесь в темноту...',0,0,0)
    }else if(hero.hp >0){
