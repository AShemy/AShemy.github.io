...
function showProfile(){
    if (profileOnOfF == 1){
        ...
        console.log('count1' in inventory.fish)
        console.log("Наживка: "+inventory.bait.info)
        console.log('Состояние fish:', inventory.fish);
        console.log('count1:', inventory.fish.count1);
        console.log('Тип count1:', typeof inventory.fish.count1);
        profileOnOfF=1
        openProfile()
        inventoryUpdate()
        openInv()
